export default function Header() {
  return (
    <header className="flex items-center justify-center  mt-8  w-full top-0 left-0 ">
      <nav className="flex items-center rounded-full ring-1 ring-white/10  text-primary-text-color font-medium justify-center w-1/4 px-6 py-3 h-10 bg-secondary-background">
